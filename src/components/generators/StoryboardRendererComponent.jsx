...
const StoryboardLayerComponent = ({ storyboard, panel }) => {
...
const StoryboardPlaceholderComponent = ({ storyboard, onPanelSelect }) => {
    // drag and drop
    const dragover = (e) => {
        e.preventDefault();
        e.stopPropagation();
            ...
            {(() => {
                if (busy) {
                    ...
                    if (panel) {
                        ...
                        return (
                            <StoryboardPlaceholderComponent
                                storyboard={storyboard}
