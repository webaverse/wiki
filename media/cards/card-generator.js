        ...
        if (!seed) {
            ...
            const DOMSVG = await fetch(
                ...
                .then((res) => {
                    ...
                    svgDom.getElementById("name").childNodes[0]._rawText =
                        description;
                    svgDom.getElementById("manaValue").childNodes[0]._rawText =
                        "33";
                    svgDom.getElementById("manaValue2").childNodes[0]._rawText =
                        "33";
                    svgDom.getElementById(
                        "healthValue"
                    ).childNodes[0]._rawText = "75";
                    svgDom.getElementById(
                        "healthValue2"
                    ).childNodes[0]._rawText = "75";
                    return svgDom;
